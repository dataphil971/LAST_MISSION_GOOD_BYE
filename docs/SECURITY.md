...
## Exception assumée : la marque du casque

Le casque porte un **losange sombre avec un C orange** — le logo de
l'entreprise. **L'employeur est donc identifiable**, ce qui sort du principe
d'anonymat total posé par le rapport de conception. C'est un choix délibéré :
